        ...
        if(isset($_POST['botonValidarCorreo'])) {
			...
			if($claveVerificada) {
                ...
                if($_SESSION['aleatorio']==$_POST["campoClaveValidacion"]) {
                    ...
                    header('Location: recuperarContrasena2.php?'.SID);
		...
		<div class="container-fluid">		
			<div class="row">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 mb-3">
                    <form action="recuperarContrasena1.php?<?=SID?>" method="POST">
			...
			<div class="row border-bottom p-5 border border-bottom-secondary cuerpo">
				...
				<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
					...
					<h6 class="subtitulo">Confirma la clave que hemos enviado a tu correo:</h6>
				</div>
